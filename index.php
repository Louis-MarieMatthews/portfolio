...
<html lang="en">
    ...
    <body>
        ...
        <main id="fullpage">
            <section class="section home-section" aria-labelledby="pf-me-section-heading">
                <div class="pf-section-content">
                    <h1 id="pf-me-section-heading">Me</h1>
            ...
            <section class="section shift-two-section" aria-labelledby="pf-shift-two-section-heading">
                <div class="pf-section-content">
                    <h1 id="pf-shift-two-section-heading">Shift-Two</h1>
            ...
            <section class="section dura-section" aria-labelledby="pf-dura-section-heading">
                <div class="pf-section-content">
                    <h1 id="pf-dura-section-heading">Dundee University Review of the Arts</h1>
            ...
            <section class="section java-and-php-section" aria-labelledby="pf-java-and-php-section-heading">
                <div class="pf-section-content">
                    <h1 id="pf-java-and-php-section-heading">Java & PHP</h1>
            ...
            <section class="section hub-section" aria-labelledby="pf-twhl-hub-section-heading">
                <div class="pf-section-content">
                    <h1 id="pf-twhl-hub-section-heading">TWHL Hub</h1>
                    <p>I joined an online community project (<a href="http://twhl.info/forums.php?thread=18885">TWHL HUB</a>) which consisted in putting together the levels made by each participant.</p>
